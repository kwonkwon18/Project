			...
			<button id="searchPlace">검색</button>
				...
				<form method="post" enctype="multipart/form-data">
					<div class="mb-3">
						...
						<input id="titleInput" class="form-control" type="text" name="title" value="${futsalBoard.title }" />
					</div>
					<div class="mb-3">
						<label for="wirterInput" class="form-label">글쓴이</label>
						<input id="wirterInput" class="form-control" type="text" name="writer" value="${futsalBoard.writer }" />
					</div>
					<div class="mb-3">
						<label for="bodyTextarea" class="form-label">본문</label>
						<textarea rows="10" id="bodyTextarea" class="form-control" name="body">${futsalBoard.body }</textarea>
					</div>
					<div class="mb-3">
