...
<body>
			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<div class="card">
					...
					<div>
						<c:forEach items="${board.fileName }" var="fileName">
							<div class="m-3">
								...
								<img class="img-fluid img-thumbnail" src="${bucketUrl }/climbingCourse/${board.id }/${fileName}" alt="" height="300" width="300" />
							</div>
						</c:forEach>
						<div class="m-3">
					...
					<div class="m-3">
						<div class="row justify-content-end">
							...
							<div class="col-md-2" style="display: flex; justify-content: flex-end;">
								<a class="btn btn-secondary" href="/climbing/courseModify/${board.id }">수정</a>
							</div>
							<div class="col-md-2">
					...
					<c:if test="${board.userId eq sessionScope['SPRING_SECURITY_CONTEXT'].authentication.name }">
						<div class="d-none">
							<form action="/climbing/courseRemove" method="post" id="removeForm">
	...
	<script src="/js/climbing/climbingCourseGet.js"></script>
	<script src="/js/climbing/climbingCourseComment.js"></script>
</body>
</html>