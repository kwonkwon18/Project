				...
				<div class="col-12 col-md-8 col-lg-6">
					...
					<div class="mb-3" style="display: none;">
						<label for="inputPassWord"> 비밀번호 </label> <input
							id="inputPassword" class="form-control" type="text"
							name="password" value="${member.password }" />
					</div>
					<div class="mb-3">
						<label for="inputName"> 이름 </label> <input id="inputName"
					...
					<div class="mb-3">
						...
						<input id="inputGender" type="text" name="gender"
					...
					<div class="mb-3">
						<label for="inputIntroduce"> 자기소개 </label> <input
							id="inputIntroduce" class="form-control" type="text"
							name="introduce" value="${member.introduce }" />
