...
<nav id="navbar-padding" class="navbar navbar-expand-lg bg-body-tertiary mb-5 fixed-top">
	<div id="navbar-container" class="container-fluid" style="background-color: green;">
		<a id="navbar-brand-link" class="navbar-brand" href="/climbing/list">
			<img src="https://bucket0503-qqwweerr11223344.s3.ap-northeast-2.amazonaws.com/project/climbing/logo/pinterest_profile_image.png" alt="..." width="80" height="70">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item">
					<a class="nav-link ${current eq 'list' ? 'active' : '' }" href="/main" style="color: white;">홈으로</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${current eq 'add' ? 'active' : '' }" href="/climbing/mateList" style="color: yellow;">메이트 구하기</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${current eq 'list' ? 'active' : '' }" href="/climbing/todayList" style="color: yellow;">오늘의 등산</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${current eq 'list' ? 'active' : '' }" href="/climbing/courseList" style="color: yellow;">추천 코스</a>
				</li>
				<li class="nav-item">
