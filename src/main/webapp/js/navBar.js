...
$("#alarmList").click(function() {
    ...
    <div id = "climbingBoard${boardId}" class="btn btn-outline-dark mb-3" style="width: 550px;">
...
<div id = "climbingBoard${boardId}" class="btn btn-outline-primary mb-3" style="width: 550px; display: flex; ">
    <div id="alarmDiv${boardId}" class="d-flex align-items-center" style="padding-right: 10px; padding-left: 10px;">
        🏕 ${title} 신청이 ${message}
    </div>
</div>
...
`);
					...
					$("#climbingMemberAlarm").append(`
<div id = "climbingBoard${boardId}" class="btn btn-outline-danger mb-3" style="width: 550px; display: flex; ">
    <div id="alarmDiv${boardId}" class="d-flex align-items-center" style="padding-right: 10px; padding-left: 10px;">
        🏕 ${title} 신청이 ${message}
    </div>
</div>
