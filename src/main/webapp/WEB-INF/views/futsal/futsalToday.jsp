			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="mb-3">
						...
						<input id="titleInput" class="form-control" type="text" name="title" value="${futsalToday.title }" />
					</div>
...
<%-- 					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<textarea rows="10" id="bodyTextarea" class="form-control" name="body">${futsalToday.body }</textarea>
					</div>
